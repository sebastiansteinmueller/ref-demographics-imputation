...
While the imputed dataset is useful in estimating regional and global estimates of the age/sex distribution of refugees, it cannot substitute data collected and compiled for and at the national level. If the main goal is to obtain reliable estimates of the demographic characteristics of refugees on the level of country of asylum, strengthening the production process of official statistics on refugees in said country should be the first order of business. Recommendations and implementation examples developed by countries in the framework of the Expert Group on Refugee, IDP and Statelessness Statistics (EGRISS) can provide helpful guidance to national statistical systems. Projecting populations from census, survey or administrative data with some data and reasonable assumption on fertility, mortality and displacement are another way to obtain more reliable estimates of the age/sex distribution at country level, although they require much more effort for a single country and are therefore better suited if estimates for a specific country are required. Estimates from the imputed dataset at any geographical level should always be disseminated and communicated with uncertainty intervals or by showing the posterior predictive distribution over imputations. The modelling approach is top-down and simply uses geographic proximity and regional groupins as a means to improve available-data figures. Promising improvements would be to use multi-year data and incorporate components of population change to obtain more reliable estimates. 
