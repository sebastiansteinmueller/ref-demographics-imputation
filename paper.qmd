...
p.top4.children.ori.asy <-  ggplot(data = dem_longMissing_geoplots,
       aes(x = origin_country, y = childrenProp*100, colour = asylum_region)) +
  ...
  labs(x = "Origin country\n(Dots proportional to population size of country of asylum)", y="Percentage of children in country of asylum") +
  theme_minimal() +
  theme(axis.text.x = element_text(size = 11, angle = 0),
    ...
    annotate("text", x = 3.6, y = 52, label = "Syrian refugees\nin Türkiye", size = 3.5) +
  geom_curve(
    data =   tibble(
    x1 = c(3.6),
    x2 = c(3.1),
