...
```{r}
# plot hierarchies and covariates
...
p.children.gni <- ggplot(data = dem_longMissing %>% 
                       filter(origin_iso3 %in% top_origin_iso3$origin_iso3, missing == "none"),
...
p.female.gni <- ggplot(data = dem_longMissing %>% 
                       filter(origin_iso3 %in% top_origin_iso3$origin_iso3, missing == "none"),
...
p.children.dist <- ggplot(data = dem_longMissing %>% 
                       filter(origin_iso3 %in% top_origin_iso3$origin_iso3, missing == "none"),
...
p.female.dist <- ggplot(data = dem_longMissing %>% 
                       filter(origin_iso3 %in% top_origin_iso3$origin_iso3, missing == "none"),
